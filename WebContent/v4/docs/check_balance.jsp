  ...
  <div class="col-md-9 content">
    <div class="dashhead">
      <div class="dashhead-titles">
        ...
        <h2 class="dashhead-title">My Account Balance</h2>
      </div>
    ...
    <div class="hr-divider mt-5 mb-3">
      <h3 class="hr-divider-content hr-divider-heading">Account Balance</h3>
    </div>
    ...
    <div class="row statcards">
      <div style="width:45%; padding-left:20px;">
        <div class="statcard statcard-danger">
          <div class="p-3">
            <span class="statcard-desc"><%=checking_acc.getAccount_type() %></span>
            <h2 class="statcard-number">
              $ <%=checking_acc.getBalance()%>
              <!--<small class="delta-indicator delta-negative">Pending</small>-->
            </h2>
          ...
          <div style="padding-top:0px; padding-bottom:20px; padding-left:20px; padding-right:20px; ">
            <span class="statcard-desc">Account No.</span>
            <b>
              <%=checking_acc.getAccount_no() %>
              <!--<small class="delta-indicator delta-negative">Pending</small>-->
            </b>
          </div>
        </div>
      ...
      <div style="width: 45%; padding-left:20px;">
        <div class="statcard statcard-success">
          <div class="p-3">
            <span class="statcard-desc"><%=saving_acc.getAccount_type() %></span>
            <h2 class="statcard-number">
              $ <%=saving_acc.getBalance() %>
          ...
          <div style="padding-top: 0; padding-bottom: 20px; padding-left:20px; padding-right:20px; ">
            <span class = "statcard-desc">Account No.</span>
            <b>
              <%=saving_acc.getAccount_no() %>
              <!--<small class="delta-indicator delta-negative">Pending</small>-->
            </b>
          </div>
        </div>
    ...
    <div class="hr-divider mt-5 mb-3">
      <h3 class="hr-divider-content hr-divider-heading">Recent Activities</h3>
    </div>
    ...
    <div class="list-group mb-3">
      <p class="list-group-item" style="color:#4D4D4D; font-weight: bold">
        <span style="padding-left: 0;">Date</span>
        <span style="padding-left: 111px;">Description</span>
        <span style="padding-left: 273px;">Account</span>
        <span style="padding-left: 133px;">Amount</span>
      </p>
      <%
        /*  	if ((!transferAmount.equals("") )&& (!((String)session.getAttribute("amount")).equals("")))  {
                  out.print("<a class=\"list-group-item\">");
                  out.print("<span style=\"padding-left: 0%;\">Nov. 17, 2017</span>");
                  out.print("<span style=\"padding-left: 55px;\">INTERNAL TRANSFER TO XXXXX"+destAcc.substring(destAcc.length() - 4)+"</span>");
                  out.print("<span style=\"padding-left: 110px;\">CHECK</span>");
                  out.print("<span style=\"padding-left: 133px\">- $ "+transferAmount+"</span>");
                  out.print("</a>");
              }*/
      %>
      <!--   <a class="list-group-item">
        <span style="padding-left: 0%;">Nov. 17, 2017</span>
        <span style="padding-left: 55px">INTERNAL TRANSFER TO XXXXX8762</span>
        <span style="padding-left: 110px;">SPEND</span>
        <span style="padding-left: 133px">- $9999</span>
      </a>-->

      <a class="list-group-item">
        <span style="padding-left: 0;">Nov. 13, 2017</span>
        <span style="padding-left: 55px;">ORIENT EXPRESS ON CARD #6127</span>
        <span style="padding-left: 132px;">CHECK</span>
        <span style="padding-left: 132px">- $29.62</span>
      </a>
      <a class="list-group-item">
        <span style="padding-left: 0;">Nov. 12, 2017</span>
        <span style="padding-left: 55px;">INTERNAL TRANSFER FROM XXXXX8762</span>
        <span style="padding-left: 90px;">CHECK</span>
        <span style="padding-left: 130px">+ $200.00</span>
      </a>
      <a class="list-group-item">
        <span style="padding-left: 0;">Nov. 12, 2017</span>
        <span style="padding-left: 55px;">INTERNAL TRANSFER FROM XXXXX8762</span>
        <span style="padding-left: 90px;">CHECK</span>
        <span style="padding-left: 130px">+ $600.00</span>
      </a>
    </div>
