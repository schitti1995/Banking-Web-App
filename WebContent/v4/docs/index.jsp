    ...
    <div class="container" style="width: 100%; padding-right: 0;">
        <div class="row">
            <div class="col-md-3" style="margin-left: 15px;">
                <div class="main-logo">
                    <a href="index.html"><img style="width: 200px;" src="images/logo/logo.png" alt=""></a>
                </div>
            </div>
            ...
            <div class="right-column">
                <div class="right-area">
                   ...
                   <div class="link_btn">
                       <a href="login.jsp" class="thm-btn">Login</a>
                       <a href="Registration.html" class="float-left" style="margin-left: 20px;">Just got your PIN?</a>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="about-info sec-padd">
                    ...
                    <div class="link">
                        <a href="#" class="default_link">More service <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="testimonials-slider column-carousel three-column">
            ...
            <article class="slide-item">
                ...
                <div class="slide-text">
                    <p>Devonshire has helped us to just have a better handle on everything in our business - to actually make decisions and move forward to grow.</p>
                </div>
            </article>
            ...
            <article class="slide-item">
                ...
                <div class="slide-text">
                    <p>It involves an examination of operations which allows their team discuss the art of the possible. They bring a wealth of knowledge, we believe Devonshire.</p>
                </div>
            </article>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="footer-column col-md-6 col-sm-6 col-xs-12">
                            <div class="footer-widget about-widget">
                                <figure class="footer-logo"><a href="index.html"><img style="width: 180px; height: auto;" src="images/logo/logo2.png" alt=""></a></figure>
                            ...
                            <div class="footer-widget contact-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="contact-info">
                                        ...
                                        <li><span class="icon fa fa-paper-plane"></span>Mail@Devonshire.com</li>
                                    </ul>
                                </div>
                                <ul class="social">
     ...
     <section class="footer-bottom">
        <div class="container">
            <div class="pull-left copy-text">
                <p>Copyright &copy; 2017. Devonshire Lending All rights reserved.</a></p>
